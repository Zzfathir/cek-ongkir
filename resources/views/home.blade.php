            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <i class="fas fa-truck fa-spin" style="font-size:70px"></i>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <i class="fas fa-box fa-spin" style="font-size:70px"></i>
                            <ul class="list-unstyled mt-3 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <i class="fas fa-plane-departure fa-spin" style="font-size:70px"></i>
                            <ul class="list-unstyled mt-3 mb-4">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="courier[]"  type="checkbox" id="{{ $key }}" value="{{ $value->code }}">
